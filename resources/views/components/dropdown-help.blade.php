...
<div class="relative inline-flex" x-data="{ open: false }">
    ...
    >
        ...
        <ul>
            <li>
                <a target="_blank" rel="noopener noreferrer" class="font-medium text-sm text-violet-500 hover:text-violet-600 dark:hover:text-violet-400 flex items-center py-1 px-3" href="https://github.com/cruip/laravel-tailwindcss-admin-dashboard-template" @click="open = false" @focus="open = true" @focusout="open = false">
            ...
            <li>
                <a target="_blank" rel="noopener noreferrer" class="font-medium text-sm text-violet-500 hover:text-violet-600 dark:hover:text-violet-400 flex items-center py-1 px-3" href="https://www.instagram.com/abdillah_azizy/" @click="open = false" @focus="open = true" @focusout="open = false">
                    <svg class="w-3 h-3 fill-current text-violet-500 shrink-0 mr-2" viewBox="0 0 12 12">
            ...
            <li>
                <a target="_blank" rel="noopener noreferrer" class="font-medium text-sm text-violet-500 hover:text-violet-600 dark:hover:text-violet-400 flex items-center py-1 px-3" href="https://www.linkedin.com/in/alif-azizy" @click="open = false" @focus="open = true" @focusout="open = false">
                    <svg class="w-3 h-3 fill-current text-violet-500 shrink-0 mr-2" viewBox="0 0 12 12">
