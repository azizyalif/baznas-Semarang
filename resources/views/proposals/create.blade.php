<x-app-layout>
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        <h3 class="text-2xl font-bold mb-2">Upload Proposal Permohonan</h3>
        <p class="text-gray-500 mb-6">Pastikan masukkan data dengan teliti.</p>



        <div id="exampleValidator">
            <form id="validation" action="{{ route('proposal/store') }}" method="POST" class="space-y-8">
                @csrf
                ...
                <div>
                    <div class="grid grid-cols-1 md:grid-cols-1 gap-6">
                        <div>
                            ...
                            <input type="text" class="w-full border rounded px-3 py-2" required name="agenda" value="{{ old('agenda') }}" />
                        </div>
                        <div>
                            <label class="block font-medium mb-1">Kode</label>
                            <input type="text" required class="w-full border rounded px-3 py-2" name="kode" value="{{ old('kode') }}" />
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input type="number" required class="w-full border rounded px-3 py-2" name="jumlah" value="{{ old('jumlah') }}" />
                        </div>
                        <div>
                            <label class="block font-medium mb-1">Tanggal Proposal Masuk</label>
                            <input type="date" required class="w-full border rounded px-3 py-2" name="proposalmasuk" value="{{ old('proposalmasuk') }}" />
                        </div>
                    </div>
                </div>

                <!-- Step 2: Data Diri Pemohon -->
                <div>
                    <div class="grid grid-cols-1 md:grid-cols-1 gap-6">
                        <div>
                            <label class="block font-medium mb-1">Nama Instansi</label>
                            <input type="text" class="w-full border rounded px-3 py-2" name="instansi" value="{{ old('instansi') }}" />
                        </div>
                        <div>
                            <label class="block font-medium mb-1">Pimpinan Organisasi</label>
                            <input type="text" class="w-full border rounded px-3 py-2" name="pimpinan" value="{{ old('pimpinan') }}" />
                        </div>
                        <div>
                            <label class="block font-medium mb-1">Nama Pemohon</label>
                            <input type="text" class="w-full border rounded px-3 py-2" name="pemohon" required value="{{ old('pemohon') }}" />
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input type="text" class="w-full border rounded px-3 py-2" name="anak" value="{{ old('anak') }}" />
                        </div>
                        <div>
                            <label class="block font-medium mb-1">NIK</label>
                            <input type="text" class="w-full border rounded px-3 py-2" name="nik" required value="{{ old('nik') }}" />
                        ...
                        <div>
                            ...
                            <input type="text" class="w-full border rounded px-3 py-2" name="ttl" required value="{{ old('ttl') }}" />
                        </div>
                        <div>
                            <label class="block font-medium mb-1">Alamat</label>
                            <input type="text" class="w-full border rounded px-3 py-2" name="alamat" required value="{{ old('alamat') }}" />
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input type="text" class="w-full border rounded px-3 py-2" name="hp" required value="{{ old('hp') }}" />
                        </div>
                        <div>
                            <label class="block font-medium mb-1">Jam Pengajuan</label>
                            <input type="time" class="w-full border rounded px-3 py-2" name="waktu" required value="{{ old('waktu') }}" />
                        </div>
                    </div>
                </div>
                ...
                <div>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input class="w-full border rounded px-3 py-2" name="pengaju" required value="{{ old('pengaju') }}" />
                        </div>
                        <div>
                            <label class="block font-medium mb-1">Tgl Penyerahan Proposal</label>
                            <input class="w-full border rounded px-3 py-2" name="penyerahan" value="{{ old('penyerahan') }}" />
                        </div>
                        <div>
                            <label class="block font-medium mb-1">Tanggal Realisasi</label>
                            <input class="w-full border rounded px-3 py-2" name="realisasi" value="{{ old('realisasi') }}" />
                        </div>
                    </div>
                </div>
