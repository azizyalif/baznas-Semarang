<x-authentication-layout>
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="space-y-4">
            <div>
                <x-label for="name">{{ __('Nama') }} <span class="text-red-500">*</span></x-label>
        ...
        <div class="flex items-center justify-between mt-6">
            <div class="mr-1">
                <label class="flex items-center" name="newsletter" id="newsletter">
                    ...
                    <span class="text-sm ml-2">Terima Info Layanan Terbaru.</span>
                </label>
            </div>
            <x-button>
                {{ __('Sign Up') }}
                ...
                <div class="mt-6">
                    <label class="flex items-start">
                        ...
                        <span class="text-sm ml-2">
                            {!! __('Saya Menyetujui Syarat & Ketentuan Yang Berlaku', [
    ...
    <div class="pt-5 mt-6 border-t border-gray-100 dark:border-gray-700/60">
        <div class="text-sm">
            {{ __('Sudah Memiliki Akun?') }} <a class="font-medium text-violet-500 hover:text-violet-600 dark:hover:text-violet-400" href="{{ route('login') }}">{{ __('Login') }}</a>
        </div>
    </div>
</x-authentication-layout>
